...
folder_name = f"seed_videos_{time_str}"
json_file_name = f"seed_videos_data_{time_str}.json"
...
print(" 🕒 正在获取抖音种草榜...")
# 获取种草榜标题
dp.listen.start("board_sub_type=seeding")
...
dp.ele('text:种草榜').click.left(by_js=True)
time.sleep(1)
r = dp.listen.wait()
...
print(seed_titles)
print(f" ✅ 成功获取 {len(seed_titles)} 个种草榜标题\n")
