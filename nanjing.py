...
folder_name = f"nanjing_videos_{time_str}"
json_file_name = f"nanjing_videos_data_{time_str}.json"
...
print(" 🕒 正在获取抖音南京榜...")
# 获取南京榜标题
dp.listen.start("board_type=1&board_sub_type=320100")
...
dp.ele('text:南京榜').click.left(by_js=True)
time.sleep(1)
r = dp.listen.wait()
...
print(seed_titles)
print(f" ✅ 成功获取 {len(seed_titles)} 个南京榜标题\n")
